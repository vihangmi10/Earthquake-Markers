...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		AbstractMapProvider provide = new Microsoft.HybridProvider();
		...
		map2 = new UnfoldingMap(this, 420,50,350,500,provide);
		map2.zoomAndPanTo(zoomLevel2, new Location(33.5, -117.5));
